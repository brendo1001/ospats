...
setwd("C:/Users/bmal4866/Dropbox/2016/rcode")
#Run Ospats
library(raster);library(gstat);library(Rcpp);library(RcppArmadillo)
sourceCpp("fastPdist.cpp") #C++ function for calculating distances
sourceCpp("fastVsum.cpp") 
...
#Run Function
tester<- ospats(data= data, dRange= ra, nCycles= ncy, dStart= 1, dMaxrun=1, dRSquare=0.4, dStrata=4, debug=FALSE, verbose=TRUE)
